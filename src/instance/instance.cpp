...
Instance::Instance(const Instance & origin,
    ...
    : resources(origin.resources), jobs(origin.jobs),
      ...
      window_extension_limit(origin.window_extension_limit),
      window_extension_job_limit(origin.window_extension_job_limit),
      window_extension_hard_deadline(origin.window_extension_hard_deadline),
...
Instance::swap(Instance & other)
{
	...
	std::swap(other.window_extension_hard_deadline,
	          this->window_extension_hard_deadline);
...
Instance::clone() const
{
	...
	cloned.set_window_extension_hard_deadline(
	    this->window_extension_hard_deadline);
...
void
Instance::set_window_extension_hard_deadline(Maybe<unsigned int> deadline_in)
{
	this->window_extension_hard_deadline = deadline_in;
}
...
Maybe<unsigned int>
Instance::get_window_extension_hard_deadline() const
{
	return this->window_extension_hard_deadline;
}
