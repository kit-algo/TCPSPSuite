...
RuntimeError::RuntimeError(const Instance &instance_in, int seed_in, int fault_code_in, std::string reason_in) noexcept
  : seed(seed_in), fault_code(fault_code_in), instance(instance_in), reason(reason_in)
{
...
InconsistentResultError::InconsistentResultError(const Instance &instance_in, int seed_in, int fault_code_in, std::string reason_in) noexcept
  : RuntimeError(instance_in, seed_in, fault_code_in, reason_in)
{}

InconsistentDataError::InconsistentDataError(const Instance &instance_in, int seed_in, int fault_code_in, std::string reason_in) noexcept
  : RuntimeError(instance_in, seed_in, fault_code_in, reason_in)
{}

ConfigurationError::ConfigurationError(const Instance &instance_in, int seed_in, int fault_code_in, std::string reason_in) noexcept
  : RuntimeError(instance_in, seed_in, fault_code_in, reason_in)
{}

ErrorHandler::ErrorHandler(Storage &storage_in, std::string solver_id_in, std::string run_id_in, std::string config_id_in)
  : storage(storage_in), solver_id(solver_id_in), run_id(run_id_in), config_id(config_id_in), l("ERRORHANDLER")
{}
...
ErrorHandler::handle_db(const RuntimeError &exception)
{
  ...
  this->storage.insert_error(exception.get_instance().get_id(), this->run_id, this->solver_id, this->config_id, exception.get_seed(), exception.EXCEPTION_ID(), exception.get_fault_code());
}
